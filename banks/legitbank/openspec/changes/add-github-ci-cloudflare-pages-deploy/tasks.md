...
- [x] 1.3 Add a deploy job that runs only on the default branch, and deploys `banks/legitbank/frontend/dist/` to Cloudflare Pages using the Wrangler CLI
- [x] 1.4 Document required GitHub repository secrets/variables for Cloudflare Pages deploy
