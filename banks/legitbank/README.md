...
## Overview
- Frontend-only demo (no required API/DB calls for core UX)
- OpenSpec-driven delivery (proposals/specs/validation)
...
## Docs
- Frontend run/build: [frontend/README.md](frontend/README.md)
- Cloudflare Pages setup (Wrangler + GitHub secrets): [docs/cloudflare-pages.md](docs/cloudflare-pages.md)
